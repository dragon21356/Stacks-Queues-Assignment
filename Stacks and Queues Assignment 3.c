...
int isStackPairwiseConsecutive(Stack *s) /*Code can be reduced as the instructions do not require you to restore the original stack*/
{
    Stack temp;
    int testitem;
    int testitem2;
    ...
    while(!isEmptyStack(s)){
        ...
        if(testitem2 - testitem == 1 || testitem - testitem2 == 1){
            push(&temp,testitem);
            push(&temp,testitem2);
        }
